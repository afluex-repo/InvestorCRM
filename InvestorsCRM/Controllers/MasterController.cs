...
namespace InvestorsCRM.Controllers
{
    public class MasterController : BaseController
    {
        ...
        public ActionResult InvestorRegistration()
        {
        ...
        [OnAction(ButtonName = "btnSave")]
        public ActionResult InvestorRegistration(Master model,HttpPostedFileBase PostedFile)
        {
            try
            {
                Random rnd = new Random();
            ...
            return RedirectToAction("InvestorRegistration", "Master");
        }
